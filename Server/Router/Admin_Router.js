...
const {serviceSchema} = require('../Validators/Auth_Validator')
...
router.route('/services').post(upload.single('images'),validate(serviceSchema),Auth_Middleware,Admin_Middleware,Admin_Controller.AddService)
router.route('/services/delete/:id').delete(Auth_Middleware,Admin_Middleware,Admin_Controller.DeleteService)
